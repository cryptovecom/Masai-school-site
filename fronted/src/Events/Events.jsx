      ...
      <div className="cont">
        <div>
          ...
          <p className="text-center text-wrap p_here text-2xl opacity-80 text-secondary">
            Learn from industry experts and test your skills against peers during our comprehensive events, masterclasses & contests. Experience impactful learning with Masai by your side.
          </p>
        </div>
      ...
      {eventData?.map((elem) => (
        <div className="parent">
          <div className="child-1 border">
           <div><h3 className=".text-secondary event_date">{elem.date}</h3></div>
           <div> <p className="font-bold flex justify-center month_p">{elem.month}</p></div>
          ...
          <div className="child-2">
            ...
            <div className="data_div">
              <div>
              <div><p className="fs-5 font-bold text-xl">{elem.title}</p></div>
              <div><p className="font-bold text-3xl posi_tion ">{elem.position}</p></div>
              </div>
              
              <div className="myData_div">
                <div className="mt-4">
                 <div><p className="hour_p font-medium">{elem.duration}</p></div>

                  <div className="time_data">
                    <div className="time-1">
                      <div><p className="font-medium">{elem.start_time}</p></div>
                      <div><p className="font-medium pm-1">{elem.type1}</p></div>
                    </div>
                    ...
                    <div className="time-2">
                      <div><p className="font-medium">{elem.end_time}</p></div>
                     <div><p className="font-medium pm-2">{elem.type2}</p></div> 
                    </div>
                  </div>

                 <div><p className="duration_p font-medium">Duration</p></div> 
                </div>
              ...
              <div className="btm_div">
                ...
                <div><p className="std_num font-medium">{elem.people}</p></div>
                 <div><p className="my_txt font-medium">people have registered</p></div>
              </div>
            </div>
