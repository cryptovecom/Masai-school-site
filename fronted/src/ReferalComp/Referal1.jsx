...
function Referal1() {
  return (
    ...
    <div className="mb-20"> 
    <h1 className="text-center font-[700] md:text-[60px] leading-20 text-[30px]">
      ...
      <div className="mx-auto max-w-9xl px-4">
        <dl className="lg:grid lg:grid-cols-3 md:gap-x-5 md:gap-y-10">
          <div className="relative">
            ...
            <p className="ml-16 lg:ml-0 text-md md:text-2xl md:text-4xl font-[700]  text-gray-900 md:text-center">
            Your friend clears the <br/> MSAT
            </p>
            <p className="ml-16 lg:ml-0 text-2xl text-gray-900 md:text-center mt-2 sm:mt-4">
              <span className="inline-flex items-center rounded-full bg-white px-3 py-0.5 md:py-4 md:px-4 text-xs md:text-4xl mr-1 font-[700] text-[#6E71CC]">
          ...
          <div className="relative">
            ...
            <p className="ml-16 lg:ml-0 text-md md:text-4xl font-[700] text-gray-900 md:text-center">
