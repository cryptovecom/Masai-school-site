      ...
      <div className="flex justify-around mt-2">
        ...
        <div className="flex ">
          ...
          <div className="ml-4 font-bold">
            <p className="tex">Software Development</p>
            <div className="flex">
              <p className="w-44">Extensive Learning Course</p>
              <p
                className="bg-pink-100 px-2 py-1
           rounded-xl mt-4 font-bold text-pink-700 "
              >
                FULL TIME
              </p>
            </div>
        ...
        <div className="flex ">
          ...
          <div className="ml-4 font-bold">
            <p className="tex2">Software Development</p>
            <div className="flex">
              <p className="w-44">Extensive Learning Course</p>
              <p
                className="bg-pink-100 px-2 py-1
